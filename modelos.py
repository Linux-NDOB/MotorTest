...
class Motocicleta(models.Model):
    ...
    propietario_cedula = models.ForeignKey('Propietario', models.DO_NOTHING, db_column='Propietario_cedula')  # Field name made lowercase.
...
class Prueba(models.Model):
    ...
    oficina_idoficina = models.ForeignKey(Oficina, models.DO_NOTHING, db_column='Oficina_idOficina')  # Field name made lowercase.
    motocicleta_placa = models.ForeignKey(Motocicleta, models.DO_NOTHING, db_column='Motocicleta_placa')  # Field name made lowercase.
