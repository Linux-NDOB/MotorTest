...
class Mq(object):
    def setupUi(self, Mq):
        ...
        self.guardar_resultado.setGeometry(QRect(450, 270, 111, 31))
        ...
        self.comenzar.setGeometry(QRect(70, 270, 111, 31))
        self.comenzar.setStyleSheet(u"background-color:#01579b; border-radius:0; color:white;")
        self.parar = QPushButton(self.tab)
        self.parar.setObjectName(u"parar")
        self.parar.setGeometry(QRect(270, 270, 111, 31))
        self.parar.setStyleSheet(u"background-color:#e91e63; border-radius:0; color:white;")
    ...
    def retranslateUi(self, Mq):
        ...
        self.label.setText("")
        self.comenzar.setText(QCoreApplication.translate("Mq", u"Start", None))
        self.parar.setText(QCoreApplication.translate("Mq", u"Stop", None))
